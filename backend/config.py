...
class Settings(BaseSettings):
    ...
    ALPACA_BASE_URL: str = Field(
        "https://paper-api.alpaca.markets", description="Alpaca Base URL"
    )
    ...
    GOOGLE_CREDS_PATH: str | None = Field(
        None, description="Path to Google Credentials JSON file"
    )
    GOOGLE_SHEET_NAME: str | None = Field(None, description="Name of the Google Sheet")
    SECRET_KEY: str = Field(
        "your-super-secret-key",
        description="Secret key for JWT. CHANGE THIS IN PRODUCTION!",
    )
