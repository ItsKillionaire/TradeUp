...
class VwapStrategy(BaseStrategy):
    def __init__(self, alpaca_service, telegram_service, google_sheets_service, trade_percentage=0.05, take_profit_pct=0.05, stop_loss_pct=0.02):
    ...
    async def run_on_trade(self, trade):
        ...
        logging.info(f"Latest Close: {latest_close:.2f}, Latest VWAP: {latest_vwap:.2f}")
