...
class SmaCrossover(BaseStrategy):
    def __init__(self, alpaca_service, risk_manager, telegram_service, google_sheets_service, short_window=40, long_window=100, trade_percentage=0.05, take_profit_pct=0.05, stop_loss_pct=0.02):
    ...
    async def run(self, symbol, timeframe, db: Session):
        ...
        if latest_position == 1.0 and current_position_qty == 0:
            ...
            logging.info(f"No new signal for {symbol} or position is aligned with signal.")
